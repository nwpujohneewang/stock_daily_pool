...
type BoardRepository interface {
	GetAll(ctx context.Context) ([]model.BoardRule, error)
	GetByCode(ctx context.Context, boardCode string) (*model.BoardRule, error)
	Upsert(ctx context.Context, rule *model.BoardRule) error
...
func (r BoardRepoImpl) GetAll(ctx context.Context) ([]model.BoardRule, error) {
...
func (r BoardRepoImpl) GetByCode(ctx context.Context, boardCode string) (*model.BoardRule, error) {
...
func (r BoardRepoImpl) Upsert(ctx context.Context, rule *model.BoardRule) error {
